...
def plot_risk_history(risk_history_all, T, moving_av=1, dataset='law school', 
    ...
    if moving_av==1:
        ...
        plt.plot(iter_, risk_history, alpha=alpha, label="risk", c='r')
        ...
        plt.plot(iter_ma, moving_average(risk_history, moving_av), alpha=alpha, label="risk - MA", c=color)
...
def plot_unfairness_history(unf_all, T, K, moving_av=1, dataset='law school', 
    ...
    for s in range(K):
        ...
        if moving_av==1:
            ...
            plt.plot(iter_, unf_history, alpha=alpha, label="unf : S="+str(s), c=colors[s])
            ...
            plt.plot(iter_ma, moving_average(unf_history, moving_av),
                     alpha=alpha, label="unf - MA : S="+str(s),c=colors[s])
